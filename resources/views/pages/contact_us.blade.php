...
<body class="landing-style-1 sidebar-main">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="title-box text-center">
                                            <h3 style="color:#A32928">Contact Us</h3>
                                            <p>We are ecstatic at the prospect of receiving you at our physical addresses or you can send us a message.</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-6">
                                        ...
                                        <div class="alert text-white bg-success mt-3" id="contactus-success-alert" style="display: none;" role="alert">
                                            <div class="iq-alert-icon">
                                                <i class="ri-checkbox-circle-line" style="font-size:1.5em"></i>
                                            </div>
                                            <div class="iq-alert-text">Message Sent Successfully!</div>
                                        ...
                                        <div class="row">
                                                <div class="col-lg-6">
                                                    <input type="text" class="form-control" id="contact_name" name="contact_name" placeholder="Your Full Name" required>
                                                </div>
                                                <div class="col-lg-6">
                                                    <input type="email" class="form-control" id="contact_email" name="contact_email" placeholder="Your Email Address" required>
                                                </div>
                                                <div class="col-lg-12">
                                                    <input type="text" class="form-control" id="contact_subject" name="contact_subject" placeholder="Your Subject" required>
                                                </div>
                                                <div class="col-lg-12">
                                                    <textarea class="form-control" id="contact_message" name="contact_message" rows="7" placeholder="Your Message" spellcheck="true" required></textarea>
                                                </div>
                                                <div class="col-lg-12">
                                                    <button class="landing-button btn-purple" type="submit">Send Message</button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="contact-box d-flex">
                                           ...
                                           <div class="contact-box d-flex">
                                            <div class="service-detail">
                                                <h4 class="mb-2 ">Republic of Ireland</h4>
                                                <ul class="iq-list column-1">
                                                    <li>
                                                        <i class="las la-map-marker" aria-hidden="true" style="font-size: 20px;"></i>
    ...
    @section('script')
    <script>
        let contactform = document.getElementById('contactus-form');
            ...
            fetch("{{route('contactusCreate')}}", {
                ...
                .then(function(data) {
                    if (data.status == 1) {
                        ...
                        document.getElementById('contactus-success-alert').style.display = 'flex';
