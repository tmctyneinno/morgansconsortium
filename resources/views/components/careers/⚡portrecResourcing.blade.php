        ...
        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid lg:grid-cols-12 gap-12 mb-16">
                ...
                <div class="lg:col-span-7 space-y-6 text-[#1e3a5f]/80 dark:text-gray-300 leading-relaxed text-sm lg:text-base">
                    <p>
                        Portrec Resourcing is the group's talent and workforce brand: executive search for board and C-suite mandates, specialist recruitment in risk, compliance, technology and finance, and managed outsourcing of entire operational functions. Dedicated candidate portals serve jobseekers and employers across the group's markets.
                    </p>
                    <p>
                        Because Portrec sits alongside OysterChecks, the group's own screening and intelligence platform, every candidate placed arrives verified to institutional standard — a level of assurance few recruiters anywhere can match.
                    </p>
                </div>
            </div>
