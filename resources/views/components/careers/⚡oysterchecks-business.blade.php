...
{
    public $stats = [
        ['number' => '4', 'label' => 'INTEGRATED CAPABILITY LAYERS'],
        ['number' => 'Real time', 'label' => 'AI-LED DECISIONS'],
        ['number' => 'ISO 27001', 'label' => 'ALIGNED INFRASTRUCTURE'],
        ['number' => 'GDPR', 'label' => 'COMPLIANT BY DESIGN'],
    ];

    public $capabilities = [
        ['id' => 'M.02.01', 'title' => 'Identity & biometrics', 'desc' => 'Real-time, AI-led identity authentication with facial, fingerprint, liveness and behavioural checks.'],
        ['id' => 'M.02.02', 'title' => 'Global background screening', 'desc' => 'Criminal, adverse media, sanctions and compliance checks; employment referencing; education verification; BPSS, BS7858, right-to-work and right-to-rent.'],
        ['id' => 'M.02.03', 'title' => 'KYC / KYB & due diligence', 'desc' => 'Document verification, PEP and sanctions screening, risk scoring and enhanced due diligence workflows at scale.'],
        ['id' => 'M.02.04', 'title' => 'AML & fraud surveillance', 'desc' => 'Real-time transaction monitoring, AI-driven fraud pattern detection, alerting, case management and audit trail.'],
        ['id' => 'M.02.05', 'title' => 'Continuous control monitoring', 'desc' => 'Independent data sourcing, control effectiveness testing and combined assurance dashboards across all three lines.'],
        ['id' => 'M.02.06', 'title' => 'Integration & infrastructure', 'desc' => 'API-first architecture, CRM connectors, enterprise-grade encryption, and cloud, hybrid or on-premise deployment aligned to GDPR and ISO 27001.'],
    ];

    public $sectors = ['Banking & Fintech', 'Healthcare & Social Care', 'Utilities & Payments', 'Recruitment & Staffing', 'Government & Public Sector', 'Security & Defence', 'Real Estate & Tenancy'];

    public $relatedDivisions = [
        [
            'id' => 'M.01. ADVISORY',
            'title' => 'Advisory & Assurance',
            'desc' => "The group's international advisory practice — governance, enterprise risk, regulatory compliance and financial-crime prevention for banks, insurers...",
            'link' => '#'
        ],
        [
            'id' => 'M.06. ENTERPRISE SERVICES',
            'title' => 'Portrec Resourcing — Talent & Workforce',
            'desc' => "The group's recruitment and workforce brand — executive search, specialist recruitment and managed outsourcing, with dedicated candidate portals...",
            'link' => '#'
        ],
    ];
};
        ...
        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid lg:grid-cols-12 gap-12 mb-16">
                ...
                <div class="lg:col-span-7 space-y-6 text-[#1e3a5f]/80 dark:text-gray-300 leading-relaxed">
                    <p>OysterChecks is the group's flagship technology product: an API-first platform bringing identity verification, global background screening, customer due diligence, financial-crime surveillance and continuous assurance into a single intelligence layer.</p>
                    <p>Born inside the group's governance and risk ecosystem, it serves organisations that cannot afford to get it wrong — banks and fintechs, government and public-sector agencies, healthcare, security and defence, recruitment and staffing, and property and tenancy services — with global data reach and local regulatory alignment.</p>
                </div>
            </div>
            ...
            <div class="flex items-start space-x-8 max-w-4xl">
                ...
                <div>
                    <blockquote class="text-2xl lg:text-3xl font-serif italic text-[#1e3a5f] dark:text-white leading-snug mb-6">
                        Verification tells you who someone was. Intelligence tells you who you are dealing with — in real time.
                    </blockquote>
        ...
        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="mb-12">
                ...
                <p class="text-[#1e3a5f]/70 dark:text-gray-400 text-sm max-w-2xl">
                    A global platform with deployment options for any industry, country or compliance framework.
                </p>
            </div>
        </div>
    </section>
    ...
    <section class="py-20 lg:py-24">
        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="mb-12">
                ...
                <h2 class="text-2xl lg:text-3xl font-serif font-bold text-[#1e3a5f] dark:text-white mb-6">Where this business meets the group.</h2>
    ...
    <section class="py-12 pb-24">
        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="border border-gray-200 dark:border-gray-800 rounded-sm p-8 lg:p-12 flex flex-col md:flex-row justify-between items-center gap-6 hover:bg-gray-50 dark:hover:bg-white/5 transition-colors duration-300">
                <div>
                    <span class="block text-[#1e3a5f]/60 dark:text-gray-500 text-xs font-bold tracking-[0.2em] uppercase mb-2">Next in the Register · M.03</span>
                    <h3 class="text-2xl font-serif font-bold text-[#1e3a5f] dark:text-white">TMC Institute — Executive Education</h3>
                </div>
