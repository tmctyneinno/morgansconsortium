...
{
     public $stats = [
        ['number' => '10', 'label' => 'MODULES IN THE FLAGSHIP PROGRAMME'],
        ['number' => '3', 'label' => 'CONTINENTS OF COHORTS'],
        ['number' => '100%', 'label' => 'PRACTITIONER-LED-FACULTY'],
    ];

    public $capabilities = [
        ['id' => 'M.03.01', 'title' => 'Executive programmes', 'desc' => 'Multi-module residencies and masterclasses for boards, C-suites and senior regulators.'],
        ['id' => 'M.03.02', 'title' => 'Professional certification', 'desc' => 'Structured pathways to designations in governance, risk, compliance and financial-crime prevention.'],
        ['id' => 'M.03.03', 'title' => 'Corporate academies', 'desc' => 'Bespoke learning academies designed, branded and run for individual institutions.'],
        ['id' => 'M.03.04', 'title' => 'Faculty & content', 'desc' => 'A global faculty of practitioners, regulators and academics, with programme content built in-house.'],
        ['id' => 'M.03.05', 'title' => 'Digital learning', 'desc' => "Blended and fully online delivery, so cohorts on three continents learn as one."],
        ['id' => 'M.03.06', 'title' => 'Scholarships & access', 'desc' => 'Funded places and scholarship programmes that widen access to the profession.'],
    ];
        ...
        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid lg:grid-cols-12 gap-12 mb-16">
                ...
                <div class="lg:col-span-7 space-y-6 text-[#1e3a5f]/80 dark:text-gray-300 leading-relaxed text-sm lg:text-base">
                    <p>
                        The Institute is the group's executive education arm: multi-module programmes for boards and senior leaders, certification pathways for practitioners, and bespoke corporate academies for organisations investing in their own bench strength.
                    </p>
                    <p>
                        Flagship work includes premier executive programmes on insurance governance, financial integrity and enterprise resilience, developed with the group's institutional partners and delivered to cohorts drawn from across Africa, Europe, the Gulf, the Americas and beyond.
                    </p>
                </div>
            </div>

            {{-- Stats Row --}}
            <div class="grid grid-cols-2 md:grid-cols-3 border border-gray-200 dark:border-gray-800 rounded-sm overflow-hidden">
