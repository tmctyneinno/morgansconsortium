        ...
        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid lg:grid-cols-12 gap-12 mb-16">
                ...
                <div class="lg:col-span-7 space-y-6 text-[#1e3a5f]/80 dark:text-gray-300 leading-relaxed text-sm lg:text-base">
                    <p>Tyneprints is the group's print and brand-production house: an online platform where clients design and order business cards, letterheads, brochures, banners, large-format signage, corporate gifts and event collateral — with instant quotes, quality control and fast doorstep delivery.</p>
                    <p>Serving more than a hundred leading brands internationally, Tyneprints also produces the group's own institutional publications and summit collateral — from programme prospectuses to staging graphics — to the same exacting standard it offers every client.</p>
                </div>
            </div>
