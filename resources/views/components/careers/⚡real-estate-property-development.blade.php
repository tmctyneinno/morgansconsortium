        ...
        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid lg:grid-cols-12 gap-12 mb-16">
                ...
                <div class="lg:col-span-7 space-y-6 text-[#1e3a5f]/80 dark:text-gray-300 leading-relaxed text-sm lg:text-base">
                    <p>
                        The Real Estate & Property Development division develops, invests in and manages residential and commercial property across the group's markets — from urban residential schemes in high-growth cities to income-producing commercial assets in established markets.
                    </p>
                    <p>
                        Every project is underwritten with institutional rigour: independent valuation, transparent title and counterparty diligence run through OysterChecks, and governance standards that international co-investors recognise.
                    </p>
                </div>
            </div>
