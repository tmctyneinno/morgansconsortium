        ...
        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid lg:grid-cols-12 gap-12 mb-16">
                ...
                <div class="lg:col-span-7 space-y-6 text-[#1e3a5f]/80 dark:text-gray-300 leading-relaxed text-sm lg:text-base">
                    <p>
                        The GRC & Financial Crime Prevention Awards & Summit is the group's flagship convening: a full day of rigorous dialogue and an evening of well-earned recognition, bringing regulators, bankers, fintech leaders and compliance professionals to one table.
                   </p>
                    <p>
                        Now in its seventh annual edition and staged in association with the IGRCFP, the 2026 programme runs across two editions the Europe Edition at the London Marriott on 6 November, and the Africa Edition at the Nairobi Marriott, Upper Hill, on 20 November. Six award pillars and more than forty categories are decided through a transparent four-stage process combining public voting with independent, conflict-free judging. Past honourees include some of the most distinguished names in global finance and governance.
                    </p>
                </div>
            </div>
