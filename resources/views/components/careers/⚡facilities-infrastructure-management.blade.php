        ...
        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid lg:grid-cols-12 gap-12 mb-16">
                ...
                <div class="lg:col-span-7 space-y-6 text-[#1e3a5f]/80 dark:text-gray-300 leading-relaxed text-sm lg:text-base">
                    <p>
                        The Facilities & Infrastructure Management division keeps estates, offices, branch networks and operational sites running — integrating hard services, soft services and workplace management under a single accountable contract.
                    </p>
                    <p>
                       For multi-site and multi-country occupiers, we offer what fragmented local providers cannot: one standard, one service-level regime and one line of accountability across an entire portfolio.
                    </p>
                </div>
            </div>
