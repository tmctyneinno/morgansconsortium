        ...
        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid lg:grid-cols-12 gap-12 mb-16">
                ...
                <div class="lg:col-span-7 space-y-6 text-[#1e3a5f]/80 dark:text-gray-300 leading-relaxed text-sm lg:text-base">
                    <p>
                        WGRCFP is the group's global community for women in governance, risk, compliance and financial-crime prevention — a network spanning banks, insurers, regulators and professional firms on every continent the group serves.
                   </p>
                    <p>
                        At its centre sits the WGRCFP Mentorship Programme: a structured, measured programme that pairs emerging professionals with senior mentors through readiness assessment, matched pairing and a nine-month progress and success-measurement framework. A dedicated award pillar at the group's global Awards & Summit recognises women's leadership across the profession each year.
                    </p>
                </div>
            </div>
