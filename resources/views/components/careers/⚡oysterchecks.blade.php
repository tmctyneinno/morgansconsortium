...
new class extends Component
{
    ...
    public $capabilities = [
        ...
        ['id' => 'M.02.03', 'title' => 'KYC / KYB & due diligence', 'desc' => 'Real-time transaction monitoring, AI-driven fraud pattern detection, alerting, case management and audit trail.'],
        ['id' => 'M.02.04', 'title' => 'Continuous control monitoring', 'desc' => 'Independent data sourcing, control effectiveness testing and combined assurance dashboards across all three lines.'],
        ['id' => 'M.02.05', 'title' => 'Integration & infrastructure', 'desc' => "API-first architecture, CRM connectors, enterprise-grade encryption, and cloud, hybrid or on-premise deployment aligned to GDPR and ISO 27001."],
    ];
        ...
        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid lg:grid-cols-12 gap-12 mb-16">
                ...
                <div class="lg:col-span-7 space-y-6 text-[#1e3a5f]/80 dark:text-gray-300 leading-relaxed text-sm lg:text-base">
                    <p>
                        OysterChecks is the group's flagship technology product: an API-first platform bringing identity verification, global background screening, customer due diligence, financial-crime surveillance and continuous assurance into a single intelligence layer.
                   </p>
                    <p>
                       Born inside the group's governance and risk ecosystem, it serves organisations that cannot afford to get it wrong — banks and fintechs, government and public-sector agencies, healthcare, security and defence, recruitment and staffing, and property and tenancy services — with global data reach and local regulatory alignment.
                    </p>
                </div>
            </div>
