    ...
    jQuery(document).ready(function() {
       ...
       /*---------------------------------------------------------------------
        ...
        jQuery(document).on("click", '.iq-menu > li > a', function() {
            ...
            if (jQuery('body').find('.iq-sidebar').width()==80 && jQuery(this).attr("data-href")){
                location.href = jQuery(this).attr("data-href");
            }
            // console.log(jQuery('body').find('.iq-sidebar').width());

            if (jQuery(this).parent().parents('.iq-submenu.collapse')){
                jQuery(this).parent().parents('.iq-submenu.collapse').toggleClass('show');
            }
            // if(jQuery(this).parent().parents('.iq-submenu.collapse').hasClass('show')){
            //     jQuery(this).parent().parents('.iq-submenu.collapse').removeClass('show');
